...
public class Game{
    ...
    /**
     * Simulates the play of this Game (consisting of three levels) and updates
    ...
    /**
     * Returns the score earned in the most recently played game, as described
     * in part (a)
     */
    public int getScore() {
        int points = 0;
     ...
     * described in part (b) Precondition: num > 0
     */
